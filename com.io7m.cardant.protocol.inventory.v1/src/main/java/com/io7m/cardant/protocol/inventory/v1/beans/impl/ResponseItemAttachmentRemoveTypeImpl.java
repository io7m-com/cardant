 ...
 */
public class ResponseItemAttachmentRemoveTypeImpl extends ResponseTypeImpl implements
  ResponseItemAttachmentRemoveType
{
  ...
  public ResponseItemAttachmentRemoveTypeImpl(final SchemaType sType)
  {
    super(sType);
  }
