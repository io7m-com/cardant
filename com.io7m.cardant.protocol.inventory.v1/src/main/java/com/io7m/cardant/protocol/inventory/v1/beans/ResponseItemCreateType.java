 ...
 */
public interface ResponseItemCreateType extends ResponseType
{
  DocumentFactory<ResponseItemCreateType> Factory = new DocumentFactory<>(
    TypeSystemHolder.typeSystem,
    "responseitemcreatetype7a6dtype");
