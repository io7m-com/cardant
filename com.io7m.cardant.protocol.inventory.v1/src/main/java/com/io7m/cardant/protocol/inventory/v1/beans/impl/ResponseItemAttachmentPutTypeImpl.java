 ...
 */
public class ResponseItemAttachmentPutTypeImpl extends ResponseTypeImpl implements
  ResponseItemAttachmentPutType
{
  ...
  public ResponseItemAttachmentPutTypeImpl(final SchemaType sType)
  {
    super(sType);
  }
