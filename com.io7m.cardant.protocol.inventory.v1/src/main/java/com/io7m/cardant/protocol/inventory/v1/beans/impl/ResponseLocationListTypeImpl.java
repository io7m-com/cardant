 ...
 */
public class ResponseLocationListTypeImpl extends ResponseTypeImpl implements
  ResponseLocationListType
{
  ...
  public ResponseLocationListTypeImpl(final SchemaType sType)
  {
    super(sType);
  }
