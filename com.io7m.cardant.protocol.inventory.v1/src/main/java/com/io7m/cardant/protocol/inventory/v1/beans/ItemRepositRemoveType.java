 ...
 */
public interface ItemRepositRemoveType extends ItemRepositType
{
  DocumentFactory<ItemRepositRemoveType> Factory = new DocumentFactory<>(
    TypeSystemHolder.typeSystem,
    "itemrepositremovetype9a92type");
