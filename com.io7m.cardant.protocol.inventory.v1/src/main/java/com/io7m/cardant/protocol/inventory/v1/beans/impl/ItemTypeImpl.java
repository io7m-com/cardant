...
public class ItemTypeImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements com.io7m.cardant.protocol.inventory.v1.beans.ItemType {
    ...
    public org.apache.xmlbeans.XmlInteger xgetCount() {
        synchronized (monitor()) {
            ...
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(PROPERTY_QNAME[5]);
            return target;
        }
    }
    ...
    public void xsetCount(org.apache.xmlbeans.XmlInteger count) {
        synchronized (monitor()) {
            ...
            target = (org.apache.xmlbeans.XmlInteger)get_store().find_attribute_user(PROPERTY_QNAME[5]);
            if (target == null) {
                target = (org.apache.xmlbeans.XmlInteger)get_store().add_attribute_user(PROPERTY_QNAME[5]);
            }
            target.set(count);
        }
    }
