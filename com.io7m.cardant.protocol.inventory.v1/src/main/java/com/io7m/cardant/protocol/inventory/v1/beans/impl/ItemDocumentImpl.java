...
import com.io7m.cardant.protocol.inventory.v1.beans.ItemDocument;
 ...
 */
public class ItemDocumentImpl extends XmlComplexContentImpl implements
  ItemDocument
{
  ...
  public ItemDocumentImpl(final SchemaType sType)
  {
    super(sType);
  }
